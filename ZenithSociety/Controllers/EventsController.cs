...
namespace ZenithSociety.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventId,EventFromDate,EventToDate,EnteredUserName,CreationDate,IsActive,ActivityCategoryId")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventId,EventFromDate,EventToDate,EnteredUserName,CreationDate,IsActive,ActivityCategoryId")] Event @event)
        {
            if (ModelState.IsValid)
            {
